                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{ route('blog.add') }}" class="btn btn-success add-btn"
                                        ...
                                        <tbody>
                                            @foreach ($blogs as $key => $blog)
                                                <tr>
                                                    ...
                                                    <td>{{ ++$key}}</td>
                                                    <td>{{ $blog->title }}</td>
                                                    <td>   <img src="{{ asset('images/blog_images/'.$blog->image) }}" alt="Blog Image" width="50" height="50" class="me-1"></td>
                                                        ...
                                                        <div class="d-flex gap-2">
                                                            ...
                                                            <div class="remove">
                                                                <button class="btn btn-sm btn-danger remove-item-btn"
                                                                    ...
                                                                    data-bs-target="#remove_data_{{ $blog->id }}">Remove</button>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <div id="remove_data_{{ $blog->id }}" class="modal fade zoomIn"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <button onclick="ajaxRequest(this)"
                                                                        data-url="{{ route('blog.delete', $blog->id) }}"
