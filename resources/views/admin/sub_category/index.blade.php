                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <a href="{{ route('sub_category.add') }}" class="btn btn-success add-btn"
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="email">Sub Category</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            @foreach ($sub_categories as $sub_category)
                                                <tr>
                                                    ...
                                                    <td class="email">{{ $sub_category->category->name }}</td>
                                                    <td class="customer_name">{{ $sub_category->name }}</td>
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <a href="{{ route('user.edit', $sub_category->id) }}"
                                                                    class="btn btn-sm btn-success edit-item-btn">Edit</a>
                                                            </div>
                                                            <div class="remove">
                                                                <button class="btn btn-sm btn-danger remove-item-btn"
                                                                    data-bs-toggle="modal" data-id="{{ $sub_category->id }}"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                                                    ...
                                                                    <button onclick="ajaxRequest(this)"
                                                                        data-url="{{ route('user.delete', $sub_category->id) }}"
